...
public class IncomePage extends BasePage{
    ...
    public void txt_trade(String value)
    {
        sendkeys(txt_trade, value, WaitStrategy.PRESENCE);
    }
    ...
    {
        return getElementText(incomeApplicationno, WaitStrategy.PRESENCE);
    }
    ...
    private final By txt_incverificationapplicationno=By.xpath("//*[@class='col-xl-6 col-lg-6 col-md-12 col-sm-12' and contains(text(),'E-INC')]");
    ...
    {
        return getElementText(txt_incverificationapplicationno, WaitStrategy.PRESENCE);
    }

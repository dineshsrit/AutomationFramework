...
public class ObcPage extends BasePage{
    ...
    private final By sebcApplicationno=By.xpath("//*[@class='col-sm-3' and contains(text(),'E-OBC')]");
    ...
    private final By txt_obcverificationapplicationno=By.xpath("//*[@class='col-xl-6 col-lg-6 col-md-12 col-sm-12 ng-tns-c204-10' and contains(text(),'E-OBC')]");
    ...
    public String getobcVerificationNo()
    {
        return getElementText(txt_obcverificationapplicationno, WaitStrategy.PRESENCE);
    }

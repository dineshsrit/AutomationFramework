...
public class TribePage extends BasePage {
    ...
    private final By tribe_dpd=By.id("tribe");

    private final By lst_caste_dpd=By.xpath("//*[@class='mdc-list-item__primary-text']");

    private final By religion_dpd=By.id("tribeReligion");
    ...
    private final By tribeApplicationno=By.xpath("//*[@class='col-sm-3' and contains(text(),'E-STO')]");
